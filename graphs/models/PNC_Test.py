...
model_urls = {
    'resnet50': '/home/lirun/.torch/models/resnet50-19c8e357.pth',
}
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, **kwargs):
        ...
        self.class_fc = nn.Linear(512 * block.expansion * 2, kwargs['num_classes'])
    ...
    def forward(self, x):
        ...
        if self.is_train:
            ...
            fc_weight = self.relu(self.class_fc.weight)
            
            fc_weight = F.normalize(fc_weight)

            self.class_fc.weight.data = fc_weight

            x = self.class_fc(x)

            return x, feature, fc_weight
...
if __name__ == "__main__":
    model = resnet_50(pretrained=True, num_class=100)
